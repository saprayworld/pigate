...
* **การพัฒนาและเชื่อมโยงข้อมูลจริงของแต่ละหน้าจอ**:
  * หน้าจอหลักต่างๆ (Dashboard, Interfaces, Firewall Policy, ฯลฯ) ปัจจุบันยังเป็นหน้าจอจำลอง (Mock Pages)
...
* **สเตปที่ 3: พัฒนาหน้า Dashboard (`01-dashboard.html`)** `[กำลังดำเนินการถัดไป]`:
  * วาดหน้า Dashboard ที่มีกราฟเครือข่ายขยับแอนิเมชันโดยใช้ `recharts`
  * ออกแบบส่วนแสดงผลข้อมูลภาพรวมระบบ และดึงประวัติการทำงานล่าสุด (Firewall Logs)
* **สเตปที่ 4: พัฒนาหน้าจอการตั้งค่าเครือข่ายและความปลอดภัย**:
  * จัดสร้างหน้า Firewall Policies พร้อมติดตั้งความสามารถในการลากจัดเรียงลำดับความสำคัญ (Drag & Drop ด้วย `@dnd-kit`)
