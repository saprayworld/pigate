...
## 4. กฎการใช้งาน Git (Git Workflow Rules)

* **การ push ตรงขึ้น branch `main` สงวนไว้สำหรับงานเอกสารเท่านั้น** (ไฟล์ใน `docs/`, README, CLAUDE.md) — repo ตั้ง branch protection ให้ `main` ต้องแก้ผ่าน pull request แต่เจ้าของโปรเจกต์ตั้งใจเปิดสิทธิ์ bypass ไว้เพื่อจัดการเอกสารได้คล่องตัว
* **การแก้ไขโค้ดทุกกรณี** (backend/frontend) **ต้องสร้าง branch แยก** (เช่น `feat/...`, `fix/...`) แล้ว merge เข้า `main` ผ่าน pull request เสมอ — ห้าม push โค้ดตรงขึ้น `main`
* **เหตุผล:** แยกงานเอกสารที่ความเสี่ยงต่ำออกจากงานโค้ดที่ต้องผ่านการ review เพื่อคงคุณภาพและประวัติการเปลี่ยนแปลงที่ตรวจสอบย้อนกลับได้

---

## 5. กฎการจัดการการเชื่อมต่อ Wi-Fi และเครือข่ายไร้สาย (Wi-Fi Configuration Rules)
