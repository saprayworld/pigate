...
ประเมินงานว่าต้องใช้ทีมงานเมื่อ ต้องสำรวจโค้ดและวางแผน หรืองานที่ใหญ่ อันนี้ต้องใช้ ai-tech-lead หรือ การลงมือแก้โค้ดเป็นส่วนใหญ่ การเพิ่มฟีเจอร์ และอื่นๆ
ประเมินเป็นว่าไม่ต้องใช้ทีมงานเมื่อ แก้โค้ดเล็กๆ ไม่กี่บรรทัด

เดิน pipeline ให้: ai-tech-lead วางแผน → ai-developer ลงมือแต่ละ task → ai-qa ตรวจ, loop แก้บั๊กกับ developer ไม่เกิน 3 รอบต่อ task, ครบแล้วเด้งกลับ tech-lead. หยุดมาถามผมเมื่อ (1) แผนเสร็จ ก่อนเริ่มโค้ด และ (2) มี task ที่ loop ครบ 3 รอบแล้วไม่ผ่าน
```
