...
func TestAddrMatcher_SubnetSlash32(t *testing.T) {
	m := newAddrMatcher([]model.AddressObject{
		{Name: "SingleHost", Type: "subnet", Value: "192.168.1.10/32"},
	})
...
func TestAddrMatcher_SubnetBareIPDefaultsTo32(t *testing.T) {
	m := newAddrMatcher([]model.AddressObject{
		{Name: "Bare", Type: "subnet", Value: "10.0.0.5"},
	})
...
func TestAddrMatcher_SubnetSlash24(t *testing.T) {
	m := newAddrMatcher([]model.AddressObject{
		{Name: "LAN", Type: "subnet", Value: "192.168.1.0/24"},
	})
...
func TestAddrMatcher_Range(t *testing.T) {
	m := newAddrMatcher([]model.AddressObject{
		{Name: "DHCPRange", Type: "range", Value: "192.168.1.100-192.168.1.150"},
	})
...
func TestAddrMatcher_MalformedValuesSkippedSilently(t *testing.T) {
	m := newAddrMatcher([]model.AddressObject{
		{Name: "BadSubnet", Type: "subnet", Value: "not-an-ip"},
		{Name: "BadRange1", Type: "range", Value: "not-a-range"},
		{Name: "BadRange2", Type: "range", Value: "10.0.0.5-not-an-ip"},
		{Name: "ReversedRange", Type: "range", Value: "10.0.0.50-10.0.0.10"},
		{Name: "MixedFamilyRange", Type: "range", Value: "10.0.0.1-::1"},
		{Name: "Empty", Type: "subnet", Value: ""},
	})
...
func TestAddrMatcher_FQDNSkipped(t *testing.T) {
	m := newAddrMatcher([]model.AddressObject{
		{Name: "SomeSite", Type: "fqdn", Value: "example.com"},
	})
...
func TestAddrMatcher_NarrowestWins(t *testing.T) {
	m := newAddrMatcher([]model.AddressObject{
		{Name: "Wide", Type: "subnet", Value: "192.168.0.0/16"},
		{Name: "Narrow24", Type: "subnet", Value: "192.168.1.0/24"},
		{Name: "Narrowest32", Type: "subnet", Value: "192.168.1.10/32"},
	})
...
func TestAddrMatcher_TieBreakByName(t *testing.T) {
	m := newAddrMatcher([]model.AddressObject{
		{Name: "Zebra", Type: "subnet", Value: "10.0.0.1/32"},
		{Name: "Alpha", Type: "subnet", Value: "10.0.0.1/32"},
	})
...
func TestAddrMatcher_IPv6(t *testing.T) {
	m := newAddrMatcher([]model.AddressObject{
		{Name: "V6Net", Type: "subnet", Value: "2001:db8::/32"},
		{Name: "V6Host", Type: "subnet", Value: "2001:db8::1/128"},
		{Name: "V6Range", Type: "range", Value: "2001:db8::10-2001:db8::20"},
	})
...
func TestAddrMatcher_IPv4MappedIPv6Input(t *testing.T) {
	m := newAddrMatcher([]model.AddressObject{
		{Name: "V4Host", Type: "subnet", Value: "192.0.2.1/32"},
	})
